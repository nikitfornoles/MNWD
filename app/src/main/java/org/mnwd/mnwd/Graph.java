...
public class Graph extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ADD
        listView = (ListView) findViewById(R.id.listView_consumptionhistory);
        getJSON();
        //
    }
    ...
    private void showConsumptionHistory(){
        ...
        ListAdapter adapter = new SimpleAdapter(
                ...
                list,
                R.layout.list_graph,
                new String[]{Config.TAG_READING_READINGID, Config.TAG_READING_BILLINGDATE, Config.TAG_READING_CONSUMPTION},
                new int[]{R.id.reading_readingid, R.id.reading_billingdate, R.id.reading_consumption}
        );
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendPostRequest(Config.URL_GETCONSUMPTIONHISTORY, parameter);
                return s;
            }
        }

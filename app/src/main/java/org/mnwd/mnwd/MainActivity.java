...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText txtEmailAd,txtPassword;
    private TextView txtRegistrationLink;
    //private TextView txtNavBarTitle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtEmailAd = (EditText) findViewById(R.id.idEditEmailAd);
        txtPassword = (EditText) findViewById(R.id.idEditPassword);
        //txtNavBarTitle = (TextView) findViewById(R.id.idTxtNavDrawerTitle);

...
public class ActivationCode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtAccountNo.setText("Activate Account Number " + passedValue);
                ...
                protected void onPostExecute(String s) {
                    ...
                    if (s.contains(conn_success)) {
                        ...
                        if (activate_status.contains(activate_sucess)) {
                            Toast.makeText (ActivationCode.this, activate_status, Toast.LENGTH_LONG).show();
                        ...
                        Toast.makeText (ActivationCode.this, s, Toast.LENGTH_LONG).show();
                    }
                }
